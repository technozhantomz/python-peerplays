...
@click.option("--account", type=str, help="Account to be modified")
@click.option(
...
@click.option("--account", help="Account to be modified", type=str)
@click.option(
...
@click.option("--account", help="Account to send from")
@unlockWallet
...
@click.option("--account", help="Account to pay the registration fee")
@click.option(
    "--password",
...
@main.command(help="Upgrade Account")
@click.pass_context
@onlineChain
@click.argument("account", nargs=1, type=str)
@unlockWallet
